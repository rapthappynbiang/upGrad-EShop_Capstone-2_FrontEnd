        ...
        return (
            <Router>
                <Switch>
                   ...
                   <Route path="/products/:id/order" exact render={()=>{ return <Order baseURL={this.baseURL}/>}}/>
                   <Route path='/products' exact  render={()=>{ return <Products baseURL={this.baseURL}/>}} /> 
                   <Route path="/modifyproduct/:id" exact render={()=>{return <ModifyProduct baseURL={this.baseURL} />}} />
                   <Route path='/addproduct' exact render={()=>{return <AddProduct baseURL={this.baseURL} />}}/>
                </Switch>
            </Router>
        )
    }
